...
//** Max Step between two notes */
const int MAX_STEP = 19; // Tom Lai
...
const vector<string> constraintNames = {
    ...
    "SP5_3M3", "SP5_3M4", "SP5_H3", "SP5_H4", "SP5_H5", "SP5_H6", "SP5_M1", "SP5_M2", "SP5_M3", "SP5_M4", "SP5_P1", "SP5_4P1", "SP5_P3", "SP5_P4", "SP5_2V_1", "SP5_2V_2", "SP5_2V_3", "SP5_2V_4", "SP5_3V_1", "SP5_3V_2", "SP5_4V_1", "SP5_4V_2"
};

const vector<string> combinedCostNames = {"1H1"};
...
/**
 * Returns the name of a constraint based on its integer value
