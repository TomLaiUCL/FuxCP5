    ...
    Part(home, nMes, mSpecies, cf, lb, ub, v_type, m_costs, g_costs, s_costs, nV, bm)
{
    ...
    */
    ...
    fifthSpeciesHIntervals = IntVarArray(home, h_intervals.size(), -MAX_STEP, MAX_STEP);
